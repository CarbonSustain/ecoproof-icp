...
dfx canister call dao_backend submit_weather_data '("user2_id", 37.7749, -122.4194, "San Francisco", 17.0, "Foggy", "https://submission_photo_url")'
dfx canister call dao_backend submit_weather_data '("user3_id", 37.7749, -122.4194, "San Francisco", 19.0, "Windy", "https://submission_photo_url")'
...
dfx canister call dao_backend submit_weather_data '("user5_id", 34.0522, -118.2437, "Los Angeles", 27.0, "Clear", "https://submission_photo_url")'
...
dfx canister call dao_backend submit_weather_data '("user2_id", 40.7128, -74.0060, "New York", 9.0, "Rainy", "https://submission_photo_url")'
dfx canister call dao_backend submit_weather_data '("user3_id", 41.8781, -87.6298, "Chicago", 7.0, "Snow", "https://submission_photo_url")'
dfx canister call dao_backend submit_weather_data '("user4_id", 41.8781, -87.6298, "Chicago", 6.0, "Windy", "https://submission_photo_url")'
...
dfx canister call dao_backend submit_weather_data '("user2_id", 47.6062, -122.3321, "Seattle", 14.0, "Cloudy", "https://submission_photo_url")'
dfx canister call dao_backend submit_weather_data '("user3_id", 25.7617, -80.1918, "Miami", 29.0, "Humid", "https://submission_photo_url")'
dfx canister call dao_backend submit_weather_data '("user4_id", 25.7617, -80.1918, "Miami", 28.5, "Hot", "https://submission_photo_url")'
dfx canister call dao_backend submit_weather_data '("user5_id", 39.7392, -104.9903, "Denver", 5.0, "Snow", "https://submission_photo_url")'
dfx canister call dao_backend submit_weather_data '("user1_id", 39.7392, -104.9903, "Denver", 6.0, "Clear", "https://submission_photo_url")'
dfx canister call dao_backend submit_weather_data '("user2_id", 32.7767, -96.7970, "Dallas", 22.0, "Sunny", "https://submission_photo_url")'
dfx canister call dao_backend submit_weather_data '("user3_id", 32.7767, -96.7970, "Dallas", 23.0, "Cloudy", "https://submission_photo_url")'
...
dfx canister call dao_backend submit_weather_data '("user5_id", 36.1627, -86.7816, "Nashville", 19.5, "Rainy", "https://submission_photo_url")'
